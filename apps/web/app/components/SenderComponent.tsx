...
const SenderComponent = ({id} : {id: string}) => {
    ...
    return (<div className="fixed bottom-[8vh] right-[1vw]">
        ...
        <video className="w-[30vmin] h-[20vmax] md:w-[30vmax] md:h-[15vmax] 2xl:w[14-vmax] 2xl:h-[7-vmax] bg-fuchsia-100  rounded-[1vw] shadow-inner" id={id} key={"sender"}>Sender</video>
    </div>)
}
